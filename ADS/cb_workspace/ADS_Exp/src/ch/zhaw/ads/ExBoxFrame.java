...
public class ExBoxFrame extends JFrame {
	...
	private static final String MENU_GRAPHICS = "Graphics";
	...
	private JMenu createViewMenu() {
		...
		addGraphicMenu(menuView);
		addTextMenu(menuView);
		
		return menuView;
	}
	
	private void addGraphicMenu(JMenu menuView) {
		JMenuItem graphic = new JMenuItem(MENU_GRAPHICS);
		graphic.addActionListener(new ActionListener() {
			
			public void actionPerformed(ActionEvent e) {
				// Remove textArea
				//set somehow Graphical interface
			}
		});
		menuView.add(graphic);
	}
	
	private void addTextMenu(JMenu menuView) {
		JMenuItem text = new JMenuItem(MENU_TEXT);
		text.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//Textfeld wieder hinzufügen
				//Graphics feld entfernen
			}
		});
		menuView.add(text);
	}
